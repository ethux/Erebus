...
def ask_file_decision(filepath: str, reason: str) -> str:
    ...
    if _in_vscode():
        ...
        if "sanitize" in result: return "sanitize"  # noqa: E701
        if "allow" in result: return "allow"  # noqa: E701
        return "block"
    ...
    if "Sanitize" in output: return "sanitize"  # noqa: E701
    if "Allow" in output: return "allow"  # noqa: E701
    return "block"
...
def ask_pii_decision(detected_items: list[str], context_snippet: str) -> str:
    ...
    if _in_vscode():
        ...
        if "block" in result: return "block"  # noqa: E701
        if "allow" in result: return "allow"  # noqa: E701
        return "tokenize"
    ...
    output = _osascript(script)
    if "Block" in output: return "block"  # noqa: E701
    if "Send Anyway" in output: return "allow"  # noqa: E701
    return "tokenize"
